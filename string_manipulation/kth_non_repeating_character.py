...
Invalid cases:
----------------
list_non_repeating_count called with ('geeksforgeeks', 0) => Result : Invalid input: Please check.
list_non_repeating_count called with ('geeksforgeeks', 45) => Result : Invalid input: Please check.
list_non_repeating_count called with (None, 45) => Result : Invalid input: Please check.
list_non_repeating_count called with ('geeksforgeeks', 5) => Result : Invalid input: Please check.
----------------
Valid cases:
----------------
list_non_repeating_count called with ('geeksforgeeks', 1) => Result : f
list_non_repeating_count called with ('geeksforgeeks', 2) => Result : o
list_non_repeating_count called with ('geeksforgeeks', 3) => Result : r
...
def list_non_repeating_count(string, k):
    if not string or k<=0 or k>len(string):
        return "Invalid input: Please check."
    ...
    non_repeated_chars = []
    for index1 in range(length):
        if string[index1] not in non_repeated_chars:
...
if __name__ == "__main__":
    ...
    function_names = [two_loop_non_repeating_count, list_non_repeating_count]
